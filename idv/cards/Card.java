...
import cards.stuffBeginnersDontHaveToUnderstand.Version;
...
public class Card implements Comparable<Card> {
    ...
    final static private long encodedVersion = 2___00001_005___2025_04_30__04L;
    //-----------------------------------------#---^^^^^-^^^---^^^^-^^-^^--^^
     ...
     * <br />
     * Bemerkung:<br />
     * Da es die &quot;Default-Denke&quot; bei einem enum ist, muss es eigentlich nicht extra erw&auml;hnt werden.
     * Wie auch immer, die Werte des enum {@link #Suit} gen&uuml;gen den Anforderungen einer Ordinal-Skala.
     */
    public enum Suit {
     ...
     * Bemerkung:<br />
     * Da es die &quot;Default-Denke&quot; bei einem enum ist, muss es eigentlich nicht extra erw&auml;hnt werden.
     * Wie auch immer, die Werte des enum {@link #Rank} gen&uuml;gen den Anforderungen einer Ordinal-Skala.
     */
    public enum Rank {
        ...
        public Rank increment(){
            if( equals( ACE )){
                ...
                return ACE; // "saturation" thinking in case assert is disabled is most reasonable
            }else{
        ...
        public Rank decrement(){
            if( equals( TWO )){
                ...
                return TWO; // "saturation" thinking in case assert is disabled is most reasonable
            }else{
                return Rank.values()[ ordinal() -1 ];
            }//if
        }//method()
    ...
    /**
     * Die (Sub-)Klasse {@link Constant} enth&auml;lt wichtige Konstanten.<br />
     * Da die einzelnen (Spiel-)Kartenwerte, wie z.B. DJ oder HQ, bewusst nicht den Anforderungen einer Ordinal-Skala gen&uuml;gen,
     * wurde bewusst kein enum verwendet, sondern die Kartenwerte werden einzeln aufgez&auml;hlt.
     */
